...
if ($_SESSION['auth_admin'] == "yes_auth")
{
    ...
    if(isset($_GET["logout"]))
    {
   	...
   	$_SESSION['urlpage'] = "<a href='index.php'>Головна</a> \ <a href='tovar.php?cat=all'>Товари</a> \ <a>Додавання товару</a>";
    ...
    if ($_SESSION['add_tovar'] == '1')
    {
        ...
        else
        {
            ...
            $_SESSION['message'] = "<p id='form-success'>Товар &quot;".$_POST['form_title']."&quot; успішно додано! Можете додати наступний:</p>";
            $id = mysql_insert_id();
...
?>
    <div id="block-content">
        <div id="block-parameters">
            <p id="title-page"><strong>Додавання товару</strong></p>
        </div>
...
?>
        ...
        <form enctype="multipart/form-data" method="post">
                ...
                <li>
                 ...
                 <li>
                    ...
                    <select name="form_type" id="type" size="1">
                        <option value="mobile">Мобільні телефони</option>
                        <option value="notebook">Ноутбуки</option>
                        <option value="notepad">Планшети</option>
                    </select>
                 </li>
                 <li>
            ...
            <ul id="chkbox">
                <li><input type="checkbox" name="chk_visible" id="chk_visible"/><label for="chk_visible">Показати товар</label></li>
                <li><input type="checkbox" name="chk_new" id="chk_new"/><label for="chk_new">Новий товар</label></li>
                <li><input type="checkbox" name="chk_leader" id="chk_leader"/><label for="chk_leader">Популяринй товар</label></li>
                <li><input type="checkbox" name="chk_sale" id="chk_sale"/><label for="chk_sale">Товар по знижці</label></li>
            </ul>
