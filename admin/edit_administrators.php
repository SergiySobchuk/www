...
if ($_SESSION['auth_admin'] == "yes_auth")
{
    ...
    if(isset($_GET["logout"]))
    {
   	...
   	$_SESSION['urlpage'] = "<a href='index.php'>Головна</a> \ <a href='edit_administrators.php'>Редагування адміністратора</a>";
    ...
    if($_SESSION['auth_admin_login'] == 'admin')
    {
        ...
        if($_POST["admin_pass"]) 
        {
            ...
            $pass   = strrev($pass);
            $pass   = "pass='".strtolower("dsfb4rf8".$pass."ds4s5")."',";
        }
...
<head>
	...
	<title>Панель керування - Редагування адміністратора</title>
</head>
<body>
    <div id="block-body">
<?php
    ...
    <div id="block-content">
        ...
        <?php
           ...
           if(mysql_num_rows($result)>0)
            ...
            <ul id="info-admin">
                <li><label>Логін*</label><input type="text" name="admin_login" value="'.$row["login"].'" disabled /></li>
                <li><label>Пароль*</label><input type="password" name="admin_pass" /></li>
                <li><label>ПІБ*</label><input type="text" name="admin_fio" value="'.$row["fio"].'" /></li>
                ...
                <li><label>№ телефона*</label><input type="text" name="admin_phone" value="'.$row["phone"].'" /></li>
            </ul>
            ...
            <p align="right"><input type="submit" id="submit_form" name="submit_edit" value="Зберегти" /></p>
        </form>
                    ';
