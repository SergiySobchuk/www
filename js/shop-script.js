$(document).ready(function(){
   ...
   loadcart();
                ...
                $.ajax(
                {
                    ...
                    success: function(data)
                    {
                        if(data == 1)
                        {
                            $(".auth-loading").hide();
                            $("#button-remind").show();
                            $('#message-remind').attr("class", "message-remind-success").html("На ваш e-mail вислано пароль.").slideDown(400);
    ...
    //шаблон перевірки емаіл на правильність
    ...
    //фунукція додавання товарів в кошик
    ...
    //фунукція онлайн зміни інформації в кошику 
    function loadcart(){
        $.ajax({
            type: "POST",
    ...
    //фунукція групування цифр по розрядах в кошику
    ...
    //функція віднімання товарів в кошику по нажаттю "-"
    ...
    //функція додавання товарів в кошику по нажаттю "-"
    ...
    //фукція введення кількості з клавіатури і нажаття ЕНТЕР    
