<?php
    ...
    $seoquery = mysql_query("SELECT seo_words, seo_description FROM table_products WHERE products_id = '$id' AND visible = '1'");
    ...
    <div id="block-body">
        ...
        $result1 = mysql_query("SELECT * FROM table_products WHERE products_id='$id' AND visible='1'",$link);
                if (mysql_num_rows($result1)>0)
                {
                    ...
                    do 
                    {
                        if(strlen($row1["image"]) > 0 && file_exists("./uploads_images/".$row1["images"]))
                        {
                        ...
                        if ($row1["type_tovara"] == "mobile") $type_tovara = "Телефони"; 
                        if ($row1["type_tovara"] == "notepad") $type_tovara = "Планшети"; 
                        if ($row1["type_tovara"] == "notebook") $type_tovara = "Ноутбуки";                      
                   ...
                   if (mysql_num_rows($result)>0)
                   {
                        ...
                        do 
                        {
                            if(strlen($row["image"]) > 0 && file_exists("./uploads_images/".$row["images"]))
                            {
                    ...
                    '
                        <ul class="tabs">
                            <li><a class="active" href="#">Опис</a></li>
                        ...
                        if (mysql_num_rows($query_reviews)>0)
                        {
                            ...
                            do
                            {
                                ...
                                <div class="block-review">
                                    <p class="autor-date"><strong>'.$row_reviews["name"].'</strong>, '.$row_reviews["date"].'</p>
                    ...
                    '
                        ...
                        <div id="send-review">
                            <p align="right" id="title-review">Публікація відгуків після попередньої модерації</p>
                            <ul type="none">
                                <li><p align="right"><label id="label-name">Імя<span>*</span></label><input maxlength="15" type="text" id="name_review"/></p></li>
                                ...
                                <li><p align="right"><label id="label-comment">Коментарі</label><textarea id="comment_review"></textarea></p></li>
                            </ul>
                            <p id="reload-img"><img src="/images/loading.gif"></p>
                            <p id="button-send-review" iid="'.$id.'"></p>
                        </div>
